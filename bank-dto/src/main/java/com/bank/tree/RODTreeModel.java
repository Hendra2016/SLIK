 ...
 *
 * The TreeModel that supports ROD, with the RODTreeNode, and any data bean that
 * implements interface RODTreeNodeData<br>
 * <br>
 *
 * The basic rule is only call getChildren while you really want to get children
 * or the children has been loaded
 *
 * @author benbai123
 *
 * @param <T>
 *            data bean implements RODTreeNodeData
 */
public class RODTreeModel<T extends RODTreeNodeData> extends RODTreeNode<T> {
	...
	/**
	 * here call getChildren since children should already be loaded to get the
	 * child
	 */
